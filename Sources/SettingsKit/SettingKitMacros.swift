...
public macro AppSettings(defaults: UserDefaults = .standard, swiftUISupport: SwiftUISupport = .observableWithBindings, createPublishers: Bool = true) = #externalMacro(module: "SettingMacros", type: "AppSettingMacro")
