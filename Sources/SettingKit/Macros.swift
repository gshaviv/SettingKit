...
public macro AppSettings(defaults: UserDefaults = .standard, createBindings: Bool = true, createPublishers: Bool = true) = #externalMacro(module: "MacrosMacros", type: "AppSettingMacro")
...
@attached(accessor)
public macro _Setting() = #externalMacro(module: "MacrosMacros", type: "SettingMacro")


@attached(peer)
public macro Default(key: String) = #externalMacro(module: "MacrosMacros", type: "DefaultValueMacro")
